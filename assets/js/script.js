...
NY METY HO TOETRY NY ANDRO ANY AN-DRANOMASINA NY ALAKAMISY 04 DESAMBRA 2025 AMIN’NY 06 ORA MARAINA HATRAMIN’NY ZOMA 05 DESAMBRA 2025 AMIN’NY 06 ORA MARAINA

**TANJONA VILANANDRO HATRANY ANALALAVA**
Mety hisy orana tandrifindrahona ny maraina.
 Ho avy Avaratra na Avaratra-Andrefana ny rivotra ka ho 10/20 Km/ora.
 Ho avy Atsinanana kosa ny maraina ka ho 10 Km/ora.
 Ho tony na hadini-panonja ny ranomasina.
 Haavon’ny onja 0.3/0.7m`,
        image: 'Image_marine_cotiere_SITEWEB-MHJ.png'
    },
    {
        message: `**BULLETIN MARINE HAUTE MER**

BULLETIN DE PRÉVISION POUR LA MARINE DESTINE A LA NAVIGATION HAUTE MER (DE 10°S A 30°S / COTES AFRICAINES A 60°E ET DE 05°S A 30°S / 60°E A 70°E) ÉTABLI PAR MÉTÉO MADAGASCAR LE 03/12/2025 A 10 TU, VALABLE LE 03/12/2025 A 10 TU JUSQU’AU 04/12/2025 A 10 TU.
...
LIGNE DE CONVERGENCE AXEE PAR 24S/50E, 27S/54E, 30S/57E ET 33S/63E

10S/20S :
VENT : OUEST A NORD-EST 05/10 LOCALEMENT 15/20 PRES DES COTES AFRICAINES ÉTAT DE LA MER : PEU AGITÉE A AGITÉE TEMPS : AVERSES ISOLÉES LOCALEMENT ORAGEUSES SUR LA PARTIE SUD`,
...
**Températures maximales** : entre 32 et 35 °C`,
    `Partiellement nuageux le matin, le temps deviendra plus instable l'après-midi avec des averses de pluie, fortes notamment sur Marovoay et AmbatoBoeny, tandis que Soalala bénéficiera d'un après-midi ensoleillé.
**Vents** : Vents faibles à modérés, principalement de secteur Sud-Ouest (entre 6 et 13 km/h), avec des rafales pouvant atteindre 18 km/h à MahajangaI.
**Températures minimales** : entre 23 et 24 °C
**Températures maximales** : entre 33 et 36 °C`,
    `Le matin sera généralement ensoleillé ou dégagé sur l'ensemble de la région, évoluant vers un après-midi nuageux avec des averses, plus marquées sur l'Ouest (Soalala, Mitsinjo), l'Est (MahajangaII) et AmbatoBoeny.
**Vents** : Vents faibles à modérés de secteur Sud à Sud-Ouest, vitesses moyennes entre 6 et 16 km/h, avec des rafales atteignant 21 km/h à MahajangaI.
**Températures minimales** : entre 23 et 24 °C
**Températures maximales** : entre 33 et 36 °C`
];
