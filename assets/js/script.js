...
NY METY HO TOETRY NY ANDRO AN-DRANOMASINA NY ZOMA 18 SEPTAMBRA 2026 AMIN’NY 06 ORA MARAINA HATRAMIN’NY SABOTSY 19 SEPTAMBRA 2026 AMIN’NY 06 ORA MARAINA

**TANJONA VILANANDRO HATRANY ANALALAVA**
ANALALAVA HATRANY AMIN’NY TANJONA BOBAOMBY Handrahona mitsitokotoko.
 Ho avy avaratra andrefana ny rivotra ny tolak’andro ka ho 10/30 Km/ora.
 Ho avy atsimo atsinanana kosa ny alina sy ny maraina eo anelanelan’i Nosy Be sy ny tanjona Bobaomby ka ho 30/45 km/ora; hiovaova any an-kafa ka ho 10/30 km/ora.
 Hadini-panonja na hanonja be ny ranomasina.
 Haavon’ny onja 0.5/1m, hahatratra 1.5/2m manakaiky ny tendrony avaratra.`,
        image: 'Image_marine_cotiere_SITEWEB-MHJ.png'
    },
    {
        message: `**BULLETIN MARINE HAUTE MER**

BULLETIN DE PRÉVISION POUR LA MARINE DESTINE A LA NAVIGATION HAUTE MER (DE 10°S A 30°S / COTES AFRICAINES A 60°E ET DE 05°S A 30°S / 60°E A 70°E) ÉTABLI PAR MÉTÉO MADAGASCAR LE 17/09/2026 A 10 TU, VALABLE LE 17/09/2026 A 10 TU JUSQU’AU 18/09/2026 A 10 TU.
...
BASSE PRESSION AU NORD-EST DE LA ZONE ;
.

ANTICYCLONE 1037 HPA CENTRE PAR 32S/67E ;
.

APPROCHE D'UN FRONT FROID AU SUD-OUEST DU BASSIN.

"

10S/20S :
10S/20S : VENT : SECTEUR EST 05/15, LOCALEMENT 20 PRES DES COTES NORD-OUEST DE MADAGASCAR.
 DEVENANT OUEST 10/15 SUR LA PARTIE SUD-EST VERS MI- PERIODE.
 ÉTAT DE LA MER : PEU AGITEE A AGITEE, LOCALEMENT FORTE AU NORD DE 12S PAR HOULE D’EST A SUD-EST.
 TEMPS : RARES AVERSES EN DÉBUT DE PERIODE.
 DEVENANT PARTIELLEMENT A PEU NUAGEUX.
”`,
    ...
    const templates = [
    `Ciel dégagé toute la journée sur l'ensemble de la région Boeny.
**Vents** : Vents faibles à modérés de secteur Est à Sud, soufflant entre 9 et 19 km/h, avec des rafales atteignant 24 km/h à MahajangaI.
**Températures minimales** : entre 20 et 23 °C
**Températures maximales** : entre 34 et 36 °C`,
    `Temps clair et ensoleillé le matin sur l'ensemble de la région. L'après-midi sera dégagé à Soalala, et ensoleillé avec quelques passages nuageux sur le reste de la région, plus particulièrement à Mitsinjo et MahajangaII.
**Vents** : Vents faibles à modérés (9 à 16 km/h), généralement de secteur Sud-Est à Sud. Des rafales atteignant 22 km/h sont possibles à MahajangaI.
**Températures minimales** : entre 20 et 22 °C
**Températures maximales** : entre 34 et 37 °C`,
    `Le temps sera ensoleillé sur la plupart de la région Boeny, avec quelques périodes de ciel peu nuageux en matinée sur l'Est (MahajangaI) et les parties intérieures (Marovoay), ainsi qu'en après-midi sur l'Ouest (Soalala).
**Vents** : Vents faibles à modérés, principalement de secteur Est à Sud-Est, avec des vitesses moyennes de 10 à 17 km/h. Des rafales jusqu'à 26 km/h sont attendues à MahajangaI.
**Températures minimales** : entre 20 et 23 °C
