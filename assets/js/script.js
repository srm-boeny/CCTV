...
NY METY HO TOETRY NY ANDRO AN-DRANOMASINA NY ZOMA 28 AOGOSITRA 2026 AMIN’NY 06 ORA MARAINA HATRAMIN’NY SABOTSY 29 AOGOSITRA 2026 AMIN’NY 06 ORA MARAINA

**TANJONA VILANANDRO HATRANY ANALALAVA**
ANALALAVA HATRANY AMIN’NY TANJONA BOBAOMBY Handrahona mitsitokotoko.
 Ho avy atsimo atsinanana ny rivotra manakaiky ny tanjona Bobaomby ka ho 45/55 km/ora, hiovaova kosa any an-kafa ka ho 20/30 km/ora.
 Hadini- panonja na hanonja be ny ranomasina.
 Haavon’ny onja 0.5/1m, hahatratra 1.5/2 kosa any amin’ny tendrony avaratra.`,
        image: 'Image_marine_cotiere_SITEWEB-MHJ.png'
    },
    {
        message: `**BULLETIN MARINE HAUTE MER**

BULLETIN DE PRÉVISION POUR LA MARINE DESTINE A LA NAVIGATION HAUTE MER (DE 10°S A 30°S / COTES AFRICAINES A 60°E ET DE 05°S A 30°S / 60°E A 70°E) ÉTABLI PAR MÉTÉO MADAGASCAR LE 27/08/2026 A 10 TU, VALABLE LE 27/08/2026 A 10 TU JUSQU’AU 28/08/2026 A 10 TU.
...
PSEUDO-FRONT FROID AXE PAR 28S/63E, 30S/67E ET 33S/72E ;
.

UN AUTRE FRONT FROID AU SUD DE 30S;
.

ANTICYCLONE 1030 HPA CENTRE PAR 30S/86E.

10S/20S :
10S/20S : VENT : SUD A SUD-EST 15/20, DEVENANT CIRCULATION CYCLONIQUE 05/15 PRES DU LITTORAL CENTRE OUEST DE MADAGASCAR.
 ÉTAT DE LA MER : PEU AGITÉE SUR LA PARTIE NORD-EST DE LA ZONE, AGITEE A FORTE AILLEURS PAR HOULE DU SUD.
 TEMPS : PLUIES SUR LA PARTIE NORD LE MATIN.`,
    ...
    const templates = [
    `Le temps sera ensoleillé et le ciel dégagé sur la majeure partie de la région Boeny, notamment sur les parties intérieures et Est comme Marovoay, Ambato Boeny et Mahajanga II, ainsi qu'à Mahajanga I et Mitsinjo. Seul Soalala, à l'Ouest, connaîtra un temps clair.
**Vents** : Vents faibles à modérés de directions variables, avec des vitesses moyennes allant de 6 à 22 km/h et une rafale pouvant atteindre 19 km/h à Marovoay.
**Températures minimales** : entre 23 et 24 °C
**Températures maximales** : entre 32 et 36 °C`,
    `Le temps sera majoritairement ensoleillé ou assez beau le matin sur la région, virant au ciel partiellement nuageux l'après-midi sur la plupart des localités, avec des averses légères prévues à MahajangaI.
**Vents** : Vents modérés à forts de secteur Sud-Est, avec des vitesses entre 12 et 19 km/h, et des rafales atteignant 33 km/h à Marovoay.
**Températures minimales** : entre 20 et 22 °C
**Températures maximales** : entre 35 et 37 °C`,
    `Ciel dégagé et temps ensoleillé sur l'ensemble de la région Boeny, excepté MahajangaI qui connaîtra un après-midi assez ensoleillé.
**Vents** : Vents modérés à forts de secteur ESE à SE, rafales atteignant 33 km/h à MahajangaI.
