...
NY METY HO TOETRY NY ANDRO AN-DRANOMASINA NY ALAHADY 24 MEY 2026 AMIN’NY 06 ORA MARAINA HATRAMIN’NY ALATSINAINY 25 MEY 2026 AMIN’NY 06 ORA MARAINA

**TANJONA VILANANDRO HATRANY ANALALAVA**
Handrahona mitsitokotoko.
 Ho avy atsinanana na atsimo atsinanana ny rivotra ka ho 20/30 km/ora; ho avy andrefana kosa ny tolak’andro ka ho 10/20 km/ora.
 Hadini-panonja ny ranomasina.
 Haavon’ny onja hanodidina ny 0.5m, tombanana ho latsak’izany indraindray.`,
        image: 'Image_marine_cotiere_SITEWEB-MHJ.png'
    },
    {
        message: `**BULLETIN MARINE HAUTE MER**

BULLETIN DE PRÉVISION POUR LA MARINE DESTINE A LA NAVIGATION HAUTE MER (DE 10°S A 30°S / COTES AFRICAINES A 60°E ET DE 05°S A 30°S / 60°E A 70°E) ÉTABLI PAR MÉTÉO MADAGASCAR LE 24/05/2026 A 10 TU, VALABLE LE 24/05/2026 A 10 TU JUSQU’AU 25/05/2026 A 10 TU.
...
FRONT FROID AXE PAR 32S/37E, 34S/40E ET 36S/46E ;
.

PSEUDO FRONT FROID AXE PAR 26S/51E, 22S/58E, 21S/61E ET 20S/70E ;
.

ANTICYCLONE 1026 HPA CENTRE PAR 33S/54E.
...
VENT : SECTEUR SUD 05/10, LOCALEMENT 15. ÉTAT DE LA MER : PEU AGITÉE A AGITÉE.
 TEMPS : RARES AVERSES LOCALES.`,
    ...
    const templates = [
    `Temps largement ensoleillé sur l'ensemble de la région Boeny, avec quelques passages nuageux à Soalala (Ouest) et MahajangaII (Est).
**Vents** : Vents faibles à modérés de secteur SE à SSE (6 à 18 km/h), avec une rafale atteignant 23 km/h à MahajangaI.
**Températures minimales** : entre 22 et 24 °C
**Températures maximales** : entre 32 et 35 °C`,
    `Temps ensoleillé et dégagé sur l'ensemble de la région, avec un ciel peu nuageux l'après-midi à Mitsinjo.
**Vents** : Vents faibles à modérés de secteur Sud-Est à Sud, avec des vitesses moyennes allant de 7 à 14 km/h. Des rafales jusqu'à 18 km/h sont attendues à MahajangaI.
**Températures minimales** : entre 22 et 23 °C
**Températures maximales** : entre 33 et 35 °C`,
    `Temps ensoleillé et ciel dégagé sur l'ensemble de la région Boeny, avec un ciel légèrement voilé l'après-midi à Soalala.
**Vents** : Vents faibles à modérés (5 à 16 km/h) de secteur Sud-Est à Sud, avec des rafales pouvant atteindre 21 km/h à MahajangaI.
**Températures minimales** : entre 22 et 23 °C
**Températures maximales** : entre 33 et 35 °C`
];
